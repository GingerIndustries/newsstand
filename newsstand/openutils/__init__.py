#  This code was not made by me, it was originally made by Antonio Valentino (https://code.activestate.com/recipes/511443-cross-platform-startfile-and-mailto-functions/) and was then updated to Python3 by Jerry Sun on StackOverflow.
